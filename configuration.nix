  ...
  systemd.user.services.nvidia-settings = {
    ...
    serviceConfig = {
      ExecStart = "${pkgs.writeScript "nvidia-settings.sh" ''
        #!/bin/sh
        nvidia-settings --assign CurrentMetaMode="DP-0: 2560_1440_100 +0+0 { ForceFullCompositionPipeline = On }, DP-2: 2560_1440_100 +2560+0 { ForceFullCompositionPipeline = On }"
      ''}";
      Restart = "always";
      RestartSec = "5s";
    };
